...
-- select에 담지 않더라도 다른컬럼의 속성으로 조건을 걸 수 있음
select
    first_name,
    last_name,
    gender
...
where
    -- gender != 'M' -- 성별이 M이 아닌 애들만
    gender <> 'M' and -- 성별이 M이 아닌 애들만
emp_no < '10050'; -- empno 이 10050보다 작고, gender가 'M'이 아닌 조건
...
emp_no not between 10005 and 4999995; -- 부정표현 (경겨값 및 사이값 포함 안하고 나머지)
